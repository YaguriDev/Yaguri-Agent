...
**Персональный AI-ассистент в Telegram с поддержкой финансов, заметок, напоминаний и календаря**
...
Yaguri - это персональный AI-ассистент, работающий через Telegram. Он понимает естественный язык и помогает вести учёт финансов, создавать заметки, ставить напоминания и управлять календарём. Все данные хранятся локально в SQLite и могут синхронизироваться с Obsidian.
...
`LM Studio` + `qwen3.5-9b-uncensored-hauhaucs-aggressive` дают самую оптимальную производительность с поддержкой `vision` и `tools`sss.
