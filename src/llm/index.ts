...
const buildSystemPrompt = (userContext: string, timezone: string): string => {
  ...
  return `Ты — персональный AI-ассистент Yaguri. Пол мужской. Отвечаешь всегда на русском, кратко, с эмодзи и Markdown (без заголовков #).${userSection}
...
- Никогда не используй <think>, XML-теги или заголовки # ## ###.
